...
_MAGNIT_STATUS_MAP: dict[str, ShipmentStatus] = {
    ...
    "ACCEPTED_AT_POINT": ShipmentStatus.READY_FOR_PICKUP,
    ...
    "RETURNED_TO_PROVIDER": ShipmentStatus.RETURNED,
    "RETURN_ACCEPTED_AT_WAREHOUSE": ShipmentStatus.RETURNED,
    "RETURNING": ShipmentStatus.RETURNING,
    "WAITING_RETURN": ShipmentStatus.RETURNING,
    "RETURN_INITIATED": ShipmentStatus.RETURNING,
    "RETURN_SEND_TO_WAREHOUSE": ShipmentStatus.RETURNING,
    "CANCELED_BY_PROVIDER": ShipmentStatus.CANCELLED,
